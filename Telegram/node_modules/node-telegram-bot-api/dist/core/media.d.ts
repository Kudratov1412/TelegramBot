 ...
 */
import type { InputMediaAnimation, InputMediaAudio, InputMediaDocument, InputMediaLivePhoto, InputMediaPhoto, InputMediaVideo, InputPaidMediaLivePhoto, InputPaidMediaPhoto, InputPaidMediaVideo, InputProfilePhoto, InputProfilePhotoAnimated, InputProfilePhotoStatic, InputSticker, InputStoryContent, InputStoryContentPhoto, InputStoryContentVideo, SendMediaGroupParams, SendPaidMediaParams } from "../../src/types/index.js";
/**
 ...
 */
export declare class MediaGroupBuilder {
 ...
 */
export declare class PaidMediaGroupBuilder {
    private readonly items;
 ...
 */
export declare class StickerSetBuilder {
    private readonly items;
    add(sticker: InputSticker): this;
    build(): InputSticker[];
}
/** A static profile photo (a still image). `.build()` returns the `InputProfilePhoto`. */
export declare class StaticProfilePhotoBuilder {
    private readonly input;
    constructor(input: Omit<InputProfilePhotoStatic, "type">);
    build(): InputProfilePhoto;
}
/** An animated profile photo (a video); `main_frame_timestamp` picks the still frame. */
export declare class AnimatedProfilePhotoBuilder {
    private readonly input;
    constructor(input: Omit<InputProfilePhotoAnimated, "type">);
    build(): InputProfilePhoto;
}
/** A photo story for `postStory`/`editStory`. `.build()` returns the `InputStoryContent`. */
export declare class PhotoStoryBuilder {
    private readonly input;
    constructor(input: Omit<InputStoryContentPhoto, "type">);
    build(): InputStoryContent;
}
/** A video story for `postStory`/`editStory`. `.build()` returns the `InputStoryContent`. */
export declare class VideoStoryBuilder {
    private readonly input;
    constructor(input: Omit<InputStoryContentVideo, "type">);
    build(): InputStoryContent;
}
