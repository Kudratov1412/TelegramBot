 ...
 */
import type { LoginUrl, RichMessageButton, RichText, SwitchInlineQueryChosenChat, User } from "../../src/types/index.js";
...
export declare function asRichText(content: RichTextContent): RichText;
/**
 ...
 */
export declare function richMessageButton(text: RichTextContent, options?: Omit<RichMessageButton, "text">): RichMessageButton;
/**
 ...
 */
export declare class RichMessageButtonBuilder {
    ...
    switchInline(query?: string): this;
    /** Switch to inline mode in the current chat. */
    switchInlineCurrent(query?: string): this;
