...
import { type WebhookOptions } from "../../src/core/webhook.js";
/**
 ...
 * ```
 */
export declare function nextAppWebhook(bot: Bot, options?: WebhookOptions): (request: Request) => Promise<Response>;
/**
 ...
 */
export declare function nodeFrameworkWebhook(bot: Bot, options?: WebhookOptions): (req: NodeLikeRequest, res: NodeLikeResponse) => Promise<void>;
/**
 ...
 * ```
 */
export declare function registerExpressWebhook(bot: Bot, app: {
...
export declare const nextPagesWebhook: typeof nodeFrameworkWebhook;
