 ...
 * ```
 */
export declare function createWebhookServer(bot: Bot, options?: WebhookServerOptions): http.Server;
 ...
 * ```
 */
export declare function startWebhook(bot: Bot, options: StartWebhookOptions): Promise<void>;
